...
sort_methods = {
    1:bubble_sort_detail,
    2:insertion_sort_detail,
    3:shell_sort_detail,
    4:quick_sort_detail,
    5:pigeonhole_sort_detail,
    6:cycle_sort_detail
}
...
def main():
    ...
    while True:
        ...
        if screen == 1:
            if click == True:
                if option1_detail.collidepoint(mx,my):
                    ...
                    if sort_method == 4:
                        algorithms.quick_sort(0,len(start_list)-1)
                    if sort_method == 5:
                        algorithms.pigeonhole_sort()
                    if sort_method == 6:
                        algorithms.cycle_sort()
        ...
        if screen == 2:
            if click == True:
                for value,method in sort_methods.items():
                    if method.collidepoint(mx,my):
                        sort_method = value
